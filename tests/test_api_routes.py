...
# Alias fixtures from conftest.py to avoid duplication
# These fixtures use the ones defined in conftest.py

@pytest.fixture
def manager_user(admin_manager_user):
    """Alias for admin_manager_user from conftest.py"""
    return admin_manager_user

@pytest.fixture
def authenticated_admin_client(logged_in_admin):
    """Alias for logged_in_admin from conftest.py"""
    return logged_in_admin

@pytest.fixture
def authenticated_manager_client(logged_in_admin_manager):
    """Alias for logged_in_admin_manager from conftest.py"""
    return logged_in_admin_manager
